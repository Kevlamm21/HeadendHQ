...
internal class VodLauncherSettingsConfiguration : IEntityTypeConfiguration<VodLauncherSettings>
{
    public void Configure(EntityTypeBuilder<VodLauncherSettings> builder)
    {
        builder.ToTable("VodLauncherSettings");
