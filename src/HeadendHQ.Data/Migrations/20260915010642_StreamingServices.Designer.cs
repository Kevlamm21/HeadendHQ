...
namespace HeadendHQ.Data.Migrations
{
    ...
    [Migration("20260915010642_StreamingServices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeadendHQ.Core.Streaming.StreamingService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("LogoBroadcasterId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HeadendHQ.Core.Catalog.Broadcasters.Broadcaster", b =>
                {
                    ...
                    b.OwnsMany("HeadendHQ.Core.Catalog.Broadcasters.StreamingAssignment", "StreamingAssignments", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER");
                            ...
                            b1.Property<string>("LogoVariant")
                                .HasColumnType("TEXT");

                            b1.Property<int>("Priority")
                                .HasColumnType("INTEGER");

                            b1.Property<int?>("StreamingServiceId")
                                .HasColumnType("INTEGER");

                            b1.Property<bool>("UseBroadcasterLogo")
                                .HasColumnType("INTEGER");

                            b1.HasKey("Id");

                            b1.HasIndex("BroadcasterId");

                            b1.HasIndex("StreamingServiceId");

                            b1.ToTable("BroadcasterStreamingAssignments", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("BroadcasterId");

                            b1.HasOne("HeadendHQ.Core.Streaming.StreamingService", null)
                                .WithMany()
                    ...
                    b.Navigation("StreamingAssignments");
                });
            ...
            modelBuilder.Entity("HeadendHQ.Core.Streaming.StreamingService", b =>
                {
                    b.OwnsMany("HeadendHQ.Core.Streaming.StreamingServiceLogo", "Logos", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("INTEGER");
                            ...
                            b1.HasIndex("StreamingServiceId", "Variant")
                                .IsUnique();

                            b1.ToTable("StreamingServiceLogos", (string)null);
